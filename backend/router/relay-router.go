...
func SetRelayRouter(router *gin.Engine) {
	...
	router.Use(middleware.ConversationStore())  // 采集请求/响应（默认关闭）
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.Distribute())
	{
		playgroundRouter.POST("/chat/completions", func(c *gin.Context) {
			controller.PlaygroundWithFormat(c, types.RelayFormatOpenAI)
		})
		playgroundRouter.POST("/responses", func(c *gin.Context) {
			controller.PlaygroundWithFormat(c, types.RelayFormatOpenAIResponses)
		})
		playgroundRouter.POST("/messages", func(c *gin.Context) {
			controller.PlaygroundWithFormat(c, types.RelayFormatClaude)
		})
		playgroundRouter.POST("/search", func(c *gin.Context) {
			controller.PlaygroundWithFormat(c, types.RelayFormatSearch)
		})
		playgroundRouter.POST("/embeddings", func(c *gin.Context) {
			controller.PlaygroundWithFormat(c, types.RelayFormatEmbedding)
		})
		playgroundRouter.POST("/rerank", func(c *gin.Context) {
			controller.PlaygroundWithFormat(c, types.RelayFormatRerank)
		})
		playgroundRouter.POST("/images/generations", func(c *gin.Context) {
			controller.PlaygroundWithFormat(c, types.RelayFormatOpenAIImage)
		})
		playgroundRouter.POST("/audio/speech", func(c *gin.Context) {
			controller.PlaygroundWithFormat(c, types.RelayFormatOpenAIAudio)
		})
	}
