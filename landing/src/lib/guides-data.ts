  ...
  "zh-CN": {
    "claude-code-third-party-api": {
      ...
      steps: [
        {
          title: "安装 clovapi",
          body: "通过 npm、Homebrew 或 winget 安装 CLI，或使用桌面客户端。",
        ...
        },
        {
          ...
          body: "将 profile 下发到 Claude Code 配置。之后启动 claude 即走该上游。",
          command: "clovapi switch --cli claude-code my-api",
        },
      ],
    ...
    "claude-code-deepseek": {
      ...
      steps: [
        ...
        },
        {
          ...
          command: "clovapi switch --cli claude-code deepseek",
        },
      ],
    ...
    "claude-code-openrouter": {
      ...
      steps: [
        ...
        {
          title: "切换到 Claude Code",
          body: "下发 profile 到 Claude Code。",
          command: "clovapi switch --cli claude-code openrouter",
        },
      ],
    ...
    "claude-code-siliconflow": {
      ...
      steps: [
        ...
        {
          title: "切换到 Claude Code",
          body: "一行命令写入 Claude Code 配置。",
          command: "clovapi switch --cli claude-code siliconflow",
        },
      ],
    ...
    "codex-third-party-api": {
      ...
      steps: [
        ...
        {
          title: "切换到 Codex",
          body: "将 profile 应用到 Codex CLI。",
          command: "clovapi switch --cli codex codex-api",
        },
      ],
  ...
  en: {
      ...
      steps: [
        {
          ...
          body: "Install via npm, Homebrew, winget, or use the desktop app.",
          command: "npm i -g @clovapi/cli",
        },
        {
        ...
        },
        {
          ...
          body: "Write the profile into Claude Code config. Launch claude with that upstream.",
          command: "clovapi switch --cli claude-code my-api",
        },
      ],
    ...
    "claude-code-openrouter": {
      ...
      steps: [
        ...
        {
          title: "Apply to Claude Code",
          body: "Switch the profile into Claude Code.",
          command: "clovapi switch --cli claude-code openrouter",
        },
      ],
    ...
    "claude-code-siliconflow": {
      ...
      steps: [
        ...
        {
          title: "Apply to Claude Code",
          body: "One command writes Claude Code config.",
          command: "clovapi switch --cli claude-code siliconflow",
        },
      ],
    ...
    "codex-third-party-api": {
      ...
      steps: [
        ...
        },
        {
          ...
          body: "Switch the profile into Codex CLI.",
          command: "clovapi switch --cli codex codex-api",
        },
      ],
