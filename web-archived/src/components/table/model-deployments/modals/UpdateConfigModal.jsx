            ...
            >
              <div className='space-y-4'>
                ...
                <Form.Input
                  ...
                  label={"镜像仓库密码"}
                  mode='password'
                  placeholder={"如果镜像为私有，请填写密码或Token"}
                />
              </div>
            </Collapse.Panel>
            ...
            >
              <div className='space-y-4'>
                <Form.Input
                  ...
                  placeholder={"例如: /bin/bash -c \"python app.py\""}
                  helpText={"多个命令用空格分隔"}
                />
                ...
                <div>
                  ...
                  {secretEnvVars.length === 0 && (
                    <div className='text-center text-gray-500 py-4 border-2 border-dashed border-red-200 rounded-lg bg-red-50'>
                      <Text type='secondary'>{"暂无机密环境变量"}</Text>
                    </div>
                  )}
                  ...
                  <Banner
                    type='info'
                    title={"机密环境变量说明"}
                    description={"机密环境变量将被加密存储，适用于存储密码、API密钥等敏感信息。"}
                    size='small'
                  />
                </div>
              </div>
