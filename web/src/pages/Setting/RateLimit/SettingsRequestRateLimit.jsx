  ...
  return (
    <>
      <Spin spinning={loading}>
        ...
        >
          <Form.Section text={"模型请求速率限制"}>
            <Row gutter={16}>
              <Col xs={24} sm={12} md={8} lg={8} xl={8}>
                <Form.Switch
                  field={'ModelRequestRateLimitEnabled'}
                  label={"启用用户模型请求速率限制（可能会影响高并发性能）"}
                  size='default'
                  checkedText='｜'
                  uncheckedText='〇'
                  onChange={(value) => {
                  ...
                  extraText={
                    <div>
                      ...
                      <ul>
                        ...
                        <li>{"分组速率配置优先级高于全局速率限制。"}</li>
                        <li>{"限制周期统一使用上方配置的“限制周期”值。"}</li>
                      </ul>
                    </div>
                  }
                  onChange={(value) => {
